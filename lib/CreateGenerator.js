...
class CreateGenerator {
  ...
  async download() {
    // 设置模板下载地址
    const modelUrl = `https://github.com/Zeng-xun/Cli-Template.git`
    ...
    await wrapLoading(
      ...
      {
        loadingMsg: chalk.blue('加载模板中...'),
        seccessfulMsg: chalk.green('master加载成功'),
        failedMsg: chalk.red('master加载失败'),
      },
      masterBranch
      //   modelUrl,
